@extends('layouts.v_template_presensi')
@section('content')

<div class="section" id="user-section">
    <div id="user-detail">
        <div class="avatar">
            <img src="{{ asset('user-ui') }}/assets/img/sample/avatar/avatar1.jpg" alt="avatar" class="imaged w64 rounded">
        </div>
        <div id="user-info">
        ...
        <div class="tab-content mt-2" style="margin-bottom:100px;">
            ...
            <div class="tab-pane fade" id="profile" role="tabpanel">
                <ul class="listview image-listview">
                    <li>
                        <div class="item">
                            <img src="{{ asset('user-ui') }}/assets/img/sample/avatar/avatar1.jpg" alt="image" class="image">
                            <div class="in">
